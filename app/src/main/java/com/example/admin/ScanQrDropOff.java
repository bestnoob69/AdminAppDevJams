...
public class ScanQrDropOff extends AppCompatActivity {

    private ScannerLiveView scannerLiveView;
    private UserService userService;
    private WashService washService;
    ProgressDialog progressDialog;
    //public String name = PreferenceManager.getDefaultSharedPreferences(this).getString("USERNAME","");
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        scannerLiveView.setScannerViewEventListener(new ScannerLiveView.ScannerViewEventListener() {
            ...
            public void onScannerStarted(ScannerLiveView scanner) {
                Toast.makeText(ScanQrDropOff.this, "Scanner Started.", Toast.LENGTH_SHORT).show();
            }

            @Override
            public void onScannerStopped(ScannerLiveView scanner) {
                Toast.makeText(ScanQrDropOff.this, "Scanner Stopped", Toast.LENGTH_SHORT).show();
            }
                ...
                userService.getUser(data, new MyRunnable() {
                    ...
                    public void run() {
                        if (HttpStatus.SC_OK == statusCode) {
                            ...
                            Toast.makeText(ScanQrDropOff.this, "Error : " + jsonResponse, Toast.LENGTH_LONG).show();
...
//                    Paper.book().write(GlobalContext.userKey, user);
                                ...
                                Intent i = new Intent(ScanQrDropOff.this,DetailsPageDuringDropOff.class);
                                startActivity(i);
